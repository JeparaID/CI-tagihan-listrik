                    ...
                    <div class="span9">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" method="post" action="formpelanggan/simpan">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input data-title="A tooltip for the input" type="text" placeholder="masukkan username" data-original-title="" class="span8 tip" name="username" id="username">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input data-title="A tooltip for the input" type="password" placeholder="Masukkan Password Anda" data-original-title="" class="span8 tip" name="password" id="password">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input data-title="A tooltip for the input" type="text" placeholder="Masukkan Nama Anda" data-original-title="" class="span8 tip" id="nama" name="nama">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea class="span8" rows="5" placeholder="Masukkan Alamat" id="alamat" name="alamat"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input data-title="A tooltip for the input" type="text" placeholder="Masukkan Email Anda" data-original-title="" class="span8 tip" id="email" name="email">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input data-title="A tooltip for the input" type="text" placeholder="Masukkan Nomor Telepon" data-original-title="" class="span8 tip" id="no_telp" name="no_telp">
                                            </div>
                                        </div>
